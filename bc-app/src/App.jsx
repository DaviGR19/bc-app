      ...
      <div style={{ background:"#1a1a1a",borderRadius:20,padding:20,width:"100%",maxWidth:360 }}>
        ...
        <div ref={containerRef} style={{ position:"relative",width:320,height:280,margin:"0 auto",overflow:"hidden",borderRadius:10,background:"#000",touchAction:"none" }}
          ...
          {ready && (<>
            ...
            {/* grid lines */}
            {[1,2].map(i=><>
              <div key={`h${i}`} style={{ position:"absolute",left:crop.x,top:crop.y+Math.round(crop.h*i/3),width:crop.w,height:1,background:"rgba(255,255,255,0.25)",pointerEvents:"none" }}/>
              <div key={`v${i}`} style={{ position:"absolute",left:crop.x+Math.round(crop.w*i/3),top:crop.y,width:1,height:crop.h,background:"rgba(255,255,255,0.25)",pointerEvents:"none" }}/>
            </>)}
